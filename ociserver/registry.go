...
type Options struct {
	...
	//
	// If WriteError is nil, [oci.WriteError] will
	...
	LocationsForDescriptor func(isManifest bool, desc oci.Descriptor) ([]string, error)
...
func (r *registry) setLocationHeader(resp http.ResponseWriter, isManifest bool, desc oci.Descriptor, defaultLocation string) error {
	loc := defaultLocation
